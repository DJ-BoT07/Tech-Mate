...
import { scheduleDelayedMatch } from '../utils/matchDelay';
  ...
  const signup = async (email, password, username) => {
    try {
      ...
      await setDoc(doc(db, 'users', userCredential.user.uid), {
        ...
        matchDelayStart: serverTimestamp()
      });

      // Schedule delayed match
      scheduleDelayedMatch(userCredential.user.uid);
